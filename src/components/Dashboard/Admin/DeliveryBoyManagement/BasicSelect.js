...
export default function BasicSelect() {
  ...
  const options = ["Default", "Inactive", "Published"];
  ...
  return (
    <div className="relative w-48 mt-1">
      ...
      <div
        ...
        className="flex h-8 items-center justify-between rounded-sm text-xs bg-[#0D0D21] px-3 py-2 text-[#0EA5E9] cursor-pointer"
      >
        <h1>{selectedValue}</h1>
        <svg
