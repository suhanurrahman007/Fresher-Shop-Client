...
const OrderCard = ({ discountPrice, order }) => {
  const listArray = [
  ...
  return (
    <div>
      <div className="relative space-y-8 bg-[#000C21] p-8 shadow-[0px_0px_30px_2px_rgba(100,100,111,0.1)] md:w-[300px]">
        {/* top part  */}
        <div>
          <Image
            width={60}
            ...
            <div className="relative h-full w-full">
              ...
              <div className="absolute left-7 top-8 flex flex-col text-xl font-semibold text-white">
                <span>
                  ...
                  <span className="text-xs">{discountPrice?.toFixed(2)}</span>
                </span>
                <span className="text-xs font-normal">/per item</span>
              </div>
            </div>
          </div>
        </div>
